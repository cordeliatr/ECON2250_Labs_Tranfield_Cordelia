...
# GDP_per_capita
GDP_per_capita <-"75.7575757576"
GDP_per_capita    

# Unemployed_individuals
Unemployed_individuals <- "2772000"
Unemployed_individuals
```
...
Q_GDP_growth_rate
length(Q_GDP_growth_rate)

# Define States
States<- c("AL","AL","AZ","AR","CA")
States
length(States)
...
**Sample covariance:** $$\frac{1}{n-1}{∑n,i=1​(xi​−xˉ)(yi​−yˉ​)}$$

**Sample correlation:** $$\frac{∑n,i=1​(xi​−xˉ)(yi​−yˉ​)}{\sqrt{∑n,i=1​(xi​−xˉ)^2∑n,i=1​(yi​−yˉ​)^2}}$$
...
#| eval: true
#| label: write-data-1
# Export the data to cps.csv in our project folder, 
